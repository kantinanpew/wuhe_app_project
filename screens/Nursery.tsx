...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, Alert, ScrollView, ActivityIndicator, SafeAreaView } from 'react-native';
...
const Nursery = ({ route }) => {
  ...
  const nurseryImages = [
    require('../assets/images/tea_nursery.png'),
    require('../assets/images/Tea-nursery-Rwanda.jpg'),
  ];
  ...
  const saveData = async () => {
    if (!seedlings || !teaVariety || !soilMixture || !shadingMethod || !costs) {
